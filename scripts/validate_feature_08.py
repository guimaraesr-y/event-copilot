...
if json.loads(text('package.json')).get('version')!='0.8.0': fail('version')
...
for n in ['RuleBasedCommandInterpreter','AICommandInterpreter','json_schema','SENSITIVE_CHANGE']:
...
for n in ['COMMAND_INTERPRETER=rule_based','OPENAI_API_KEY=']:
...
print('\nMini-feature 08 validation passed.')
